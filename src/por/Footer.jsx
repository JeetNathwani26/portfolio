...
const Footer = () => {
  ...
  return (
    <footer className="relative theme-surface-muted border-t theme-border pt-16 pb-8 overflow-hidden z-10 theme-text">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 border-b theme-border pb-12">
          ...
          <div className="md:col-span-5 flex flex-col items-center md:items-start text-center md:text-left">
            <a href="#home" onClick={scrollToTop} className="text-3xl font-black tracking-tighter theme-text hover:text-[color:var(--page-primary)] transition-colors mb-4 inline-flex items-center gap-1 cursor-pointer">
              <span className="text-[color:var(--page-primary)]">.</span>JN
            </a>
            <p className="theme-muted max-w-sm mb-6 leading-relaxed">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://wa.me/917567120438" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full theme-surface-strong theme-border border text-[color:var(--page-muted)] hover:text-[#25D366] hover:border-[#25D366] transition-colors">
          ...
          <div className="md:col-span-4 flex flex-col items-center md:items-start">
            <h4 className="text-lg font-bold theme-text mb-6">Quick Links</h4>
            <ul className="flex flex-col gap-3 text-center md:text-left">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <a href={link.href} className="theme-muted hover:text-[color:var(--page-primary)] transition-colors font-medium">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div className="md:col-span-3 flex flex-col items-center md:items-start">
            <h4 className="text-lg font-bold theme-text mb-6">Contact</h4>
            <ul className="flex flex-col gap-4 text-center md:text-left">
              <li className="theme-muted">
                <span className="block font-medium theme-text mb-1">Email</span>
                <a href={emailHref} className="theme-text hover:text-[color:var(--page-primary)] transition-colors break-all">jeetnathwani660@gmail.com</a>
              </li>
              <li className="theme-muted">
                <span className="block font-medium theme-text mb-1">Location</span>
